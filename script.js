...
function isAllowedDirection(direction){
	if ((((currentDirection == directions.LFET) || (currentDirection == directions.RIGHT)) && ((direction == directions.RIGHT) || (direction == directions.LEFT)))
...
function moveSnake(direction){
	...
	snakeTail = {y: _snakeTail.y, x: _snakeTail.x};
	for(var i = snake.length - 1; i > 0; i--){
		currentCell = snake[i];
		higherCell = snake[i - 1]
